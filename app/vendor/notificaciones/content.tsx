...
interface VendorNotificationsContentProps {
    notifications: Notification[]
    userId: string
}

export function VendorNotificationsContent({ notifications, userId }: VendorNotificationsContentProps) {
    const { t } = useLanguage()
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        {t("notifications.subtitle.vendor")}
                    </p>
                </div>
                {unreadCount > 0 && (
                    <Button
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-2xl font-bold text-foreground">
                                    {items.filter(n => n.type === "commission_paid").length}
                                </p>
                                <p className="text-xs text-muted-foreground">{t("notifications.stats.commissions")}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
            ...
            <Card className="border-border">
                <CardHeader>
                    ...
                    <CardDescription>{t("notifications.recent.desc.vendor")}</CardDescription>
                </CardHeader>
                <CardContent>
                    {items.length === 0 ? (
